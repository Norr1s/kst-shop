            ...
            <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php if ($rows > 0): ?>
                            <?php while ($product = mysqli_fetch_assoc($query)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Are your sure you want delete?');" role="button" href="/cart-delete.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-eraser me-1"></i>Delete</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                            <tr>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6">
                                    <h4 class="text-center text-danger">no items in the cart</h4>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
